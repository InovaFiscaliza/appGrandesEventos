...
def buscar_planilhas(client):
    ...
    try:
        ...
        print("Arquivos encontrados:", [arq["name"] for arq in arquivos])
        ...
        for nome_aba in estacoes:
            try:
                ...
                if found["data"]:
                    ...
                    if len(pend.columns) > 3:
                        out["Data"] = pend.iloc[:, 3]
                    elif len(pend.columns) > 1:
                        out["Data"] = pend.iloc[:, 1]
                    else:
                        out["Data"] = ""
        ...
        if st.button("Registrar Emissão", use_container_width=True):
            ...
            if erros:
                ...
                dados_submit = {
                    ...
                    "Largura em kHz": (
                        larg if larg is not None else 0.0
                    ),  # Evita erro se larg for vazio
